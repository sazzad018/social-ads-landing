...
const Testimonials: React.FC = () => {
  return (
    <section className="py-16 lg:py-24 relative overflow-hidden">
      ...
      <div className="absolute top-0 right-0 -mr-20 -mt-20 w-[600px] h-[600px] bg-orange-50/50 rounded-full blur-3xl -z-10 pointer-events-none opacity-60"></div>
            ...
            >
              ...
              <div className="flex items-center mt-auto border-t border-gray-50 pt-5">
                <img 
                  src={item.image} 
                  alt={item.name} 
                  className="w-12 h-12 rounded-full object-cover border-2 border-orange-100 mr-4"
                />
                <div>
